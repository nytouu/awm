...
local function set_keybindings ()
    ...
    awful.keyboard.append_global_keybindings({
        ...
        -- utilities
        awful.key({ modkey,         }, "p", function () awful.spawn("takescreenshot") end,
        ...
        awful.key({ "Shift" }, "XF86AudioRaiseVolume", function () awful.spawn("mpc volume +2") end,
    ...
    awful.keyboard.append_global_keybindings({
        ...
        awful.key({ modkey, "Shift" }, "v", function () awful.screen.focus_relative( 1) end,
