...
local empty_notifbox = require("ui.dashboard.notif-center.build-notifbox.empty-notifbox")
local notifbox_scroller = require("ui.dashboard.notif-center.build-notifbox.notifbox-scroller")
...
local notifbox_add = function(n, notif_icon, notifbox_color)
	...
	local notifbox_box = require("ui.dashboard.notif-center.build-notifbox.notifbox-builder")
	notif_core.notifbox_layout:insert(1, notifbox_box(n, notif_icon, n.title, n.message, n.app_name, notifbox_color))
end

naughty.connect_signal("request::display", function(n)
	local notifbox_color = beautiful.light_black
	if n.urgency == "critical" then
		notifbox_color = n.bg_normal .. "ff"
	end
