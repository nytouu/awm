...
function timer:new()
                  ...
                  {
                    {
                      ...
                      markup = helpers.colorize_text("󰍴", beautiful.fg_normal),
                      valign = "center",
                      align = "start",
                      widget = wibox.widget.textbox,
                    },
                  ...
                  {
                    {
                      id = "increasetime",
                      font = beautiful.nerd_font .. " 20",
                      markup = helpers.colorize_text("󰐕", beautiful.fg_normal),
                      valign = "center",
                      align = "start",
                      widget = wibox.widget.textbox,
                    },
  ...
  function self:update()
    ...
    if self.timeRemaining == 0 then
      awful.spawn.with_shell("notify-send -a 'Pomodoro timer' 'Time is up!' 'Get some rest'")
    end
  end
