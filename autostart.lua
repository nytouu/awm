...
awful.spawn.once("xidlehook --not-when-fullscreen --not-when-audio --timer 120 'brightnessctl -s && brightnessctl s 0' 'brightnessctl -r' --timer 160 'lock' 'brightnessctl -r' --timer 180 'xset dpms force off' ''", false)
